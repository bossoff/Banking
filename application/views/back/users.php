                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                        <table class="table table-report ">
                            <thead>
                                <tr>
                                    <th class="whitespace-no-wrap">User Image</th>
                                    <th class="whitespace-no-wrap">Fullname</th>
                                    <th class="text-center whitespace-no-wrap">Mother Name</th>
                                    ...
                                    <th class="text-center whitespace-no-wrap">Creation_date</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="" class="tooltip rounded-full" src="<?=base_url();?><?=$users['images'];?>" title="Uploaded at 21 December 2020">
                                            </div>                                            
                                        </div>
                                    </td>

                                    <td>
                                        <a href="<?=$users['uid'];?>" class="font-medium whitespace-no-wrap"><?=$users['firstname'].' '.$users['lastname'];?></a> 
                                        <div class="text-gray-600 text-xs whitespace-no-wrap">View The Amounth on this Account</div>
                                    </td>
                                    <td class="text-center"><?=$users['mother'];?></td>
                                    <td class="text-center"><?=$users['dob'];?></td>
                                    ...
                                    <td class="text-center"><?=$users['info'];?></td>
